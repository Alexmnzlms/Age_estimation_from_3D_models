\section{Resultados divididos en niños/adultos/ancianos}
...
% \hline
% Red & Datos & Rango & N muestras & MAE avg & MAE std & MAE min & RMSE avg & RMSE std & RMSE min \\ 
% \hline
% \multirow{4}{*}{Resnet-CNN} & \multirow{4}{*}{RGB} & Total & 2200 & 8,33 & 0,64 & 7,92 & 11,18 & 0,69 & 10,73 \\
%  &  & 15 - 18 & 200 & 9,60 & 3,73 & 5,96 & 12,98 & 3,64 & 9,70 \\
%  &  & 19 - 64 & 1960 & 7,70 & 0,39 & 7,39 & 9,96 & 0,48 & 9,51 \\
...
%  &  & 65 - 90 & 40 & 28,89 & 3,01 & 24,39 & 29,51 & 3,09 & 24,88 \\ 
% \hline
...
% \end{tabular}
% }
% \caption[]{Resultados RMSE y MAE para niños/adultos/ancianos totales para un conjunto de test con aumento de datos}
...
\hline
\multirow{4}{*}{Panorama-CNN} & \multirow{4}{*}{FM} & Total & 2200 & 8,9952 & 8,7591 & 9,6103 & 11,1693 & 9,5134 \\
...
\caption[Resultados MAE para niños/adultos/ancianos por ejecución para un conjunto de test con aumento de datos.]{Resultados MAE para niños/adultos/ancianos por ejecución para un conjunto de test con aumento de datos. \textbf{Datos}: RBG, imágenes RGB; FM, mapas de características.}
\label{tab:r3_c_mae}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{table}[ht]
...
\hline
\multirow{4}{*}{Panorama-CNN} & \multirow{4}{*}{FM} & Total & 2200 & 11,8915 & 11,3773 & 12,1722 & 14,0285 & 12,4515 \\
...
\caption[Resultados RMSE para niños/adultos/ancianos por ejecución para un conjunto de test con aumento de datos.]{Resultados RMSE para niños/adultos/ancianos por ejecución para un conjunto de test con aumento de datos. \textbf{Datos}: RBG, imágenes RGB; FM, mapas de características.}
\label{tab:r3_c_rmse}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Red & Datos & Rango & N muestras & MAE avg & MAE std & MAE min & RMSE avg & RMSE std & RMSE min \\ 
% \hline
% \multirow{4}{*}{Resnet-CNN} & \multirow{4}{*}{RGB} & Total & 110 & 8,55 & 0,86 & 7,95 & 11,89 & 0,92 & 11,10 \\
%  &  & 15 - 18 & 10 & 9,93 & 5,23 & 4,69 & 11,36 & 4,79 & 5,37 \\
%  &  & 19 - 64 & 98 & 7,66 & 0,48 & 7,22 & 9,74 & 0,68 & 9,26 \\
%  &  & 65 - 90 & 2 & 45,31 & 1,83 & 43,19 & 32,35 & 3,02 & 29,16 \\ 
% \hline
% \multirow{4}{*}{Panorama-CNN} & \multirow{4}{*}{RGB} & Total & 110 & 8,72 & 0,44 & 8,18 & 11,09 & 0,44 & 10,70 \\
%  &  & 15 - 18 & 10 & 9,26 & 2,19 & 5,65 & 11,48 & 2,22 & 8,03 \\
%  &  & 19 - 64 & 98 & 8,23 & 0,47 & 7,78 & 10,27 & 0,58 & 9,78 \\
%  &  & 65 - 90 & 2 & 29,63 & 2,92 & 24,79 & 30,09 & 2,84 & 25,29 \\ 
% \hline
% \multirow{4}{*}{Panorama-CNN} & \multirow{4}{*}{Mapas de características} & Total & 110 & 13,03 & 2,20 & 10,57 & 15,32 & 2,09 & 12,94 \\
...
% \end{tabular}
% }
% \caption[]{Resultados RMSE y MAE para niños/adultos/ancianos totales para un conjunto de test sin aumento de datos}
...
\hline
\multirow{4}{*}{Panorama-CNN} & \multirow{4}{*}{FM} & Total & 110 & 13,8048 & 10,8471 & 14,4774 & 10,5711 & 15,4329 \\
...
\caption[Resultados MAE para niños/adultos/ancianos por ejecución para un conjunto de test sin aumento de datos.]{Resultados MAE para niños/adultos/ancianos por ejecución para un conjunto de test sin aumento de datos. \textbf{Datos}: RBG, imágenes RGB; FM, mapas de características.}
\label{tab:r3_s_mae}
\end{table}
\newpage
~\newpage
...
\hline
\multirow{4}{*}{Panorama-CNN} & \multirow{4}{*}{FM} & Total & 110 & 15,9380 & 12,9359 & 16,7342 & 13,3244 & 17,6643 \\
...
\caption[Resultados RMSE para niños/adultos/ancianos por ejecución para un conjunto de test sin aumento de datos.]{Resultados RMSE para niños/adultos/ancianos por ejecución para un conjunto de test sin aumento de datos. \textbf{Datos}: RBG, imágenes RGB; FM, mapas de características.}
\label{tab:r3_s_rmse}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%