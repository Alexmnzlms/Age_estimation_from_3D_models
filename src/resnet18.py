# From: https://raw.githubusercontent.com/acoadmarmon/resnet18-tensorflow/refs/heads/master/resnet_18.py
...
def ResNet18(input_tensor = None, include_top=False, weights=None, input_shape=None, layer_params=[2, 2, 2, 2], pooling=None):
    ...
    x = tf.keras.layers.ZeroPadding2D(padding=(3, 3), name='conv1_pad')(input_tensor)
    ...
    model = tf.keras.Model(input_tensor, x, name='resnet18')
    return model
